...
internal fun Project.configureHotReloadTestTasks() {
    tasks.withType(HotReloadTestTask::class.java).configureEach { task ->
...
private fun KotlinTarget.configureDefaultHotReloadTestTask() {
    ...
    val compilation = compilations.create("reloadTest")
