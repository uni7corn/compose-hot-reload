...
private val coldUIClasspath
    get() = System.getProperty("compose.ui.class.path.cold")?.split(File.pathSeparator)?.map(::Path).orEmpty()

private val hotUIClasspath
    get() = System.getProperty("compose.ui.class.path.hot")?.split(File.pathSeparator)?.map(::Path).orEmpty()
