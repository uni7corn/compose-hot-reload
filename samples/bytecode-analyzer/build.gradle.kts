...
kotlin {
    ...
    sourceSets.commonMain.dependencies {
        implementation("org.jetbrains.compose.hot-reload:hot-reload-core:1.1.0-beta+196")
        implementation("org.jetbrains.compose.hot-reload:hot-reload-analysis:1.1.0-beta+196")
