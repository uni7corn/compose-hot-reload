...
kotlin {
    ...
    sourceSets.commonMain.dependencies {
        implementation("org.jetbrains.compose.hot-reload:hot-reload-core:1.0.0-rc01+158")
        implementation("org.jetbrains.compose.hot-reload:hot-reload-analysis:1.0.0-rc01+158")
